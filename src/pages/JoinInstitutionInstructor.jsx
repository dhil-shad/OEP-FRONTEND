...
export default function JoinInstitutionInstructor() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setStatus({ type: 'success', message: `Your instructor join request has been sent! Waiting for institution approval.` });
            setUid('');
            setSelectedDept('');
            setDepartments([]);
        } catch (err) {
            ...
            <div className="max-w-md w-full relative">
                ...
                <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-xl border border-slate-100 dark:border-slate-700 mt-4 overflow-hidden">
                    <div className="px-8 pt-12 pb-8">
                        <h2 className="text-2xl font-black text-center text-slate-900 dark:text-white mb-2">Join as Instructor</h2>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    >
                                        <option value="">{fetchingDepts ? 'Fetching departments...' : departments.length > 0 ? 'Choose your department' : (uid.length === 8 ? 'No departments available' : 'Enter a valid UID first')}</option>
                            ...
                            <button
                                type="submit"
                                disabled={loading || !uid || !selectedDept}
